...
class Model_Evolution_Predictor():
    ...
    def calc_delta_matrix_F81(self, frequency_A, frequency_G, frequency_C, frequency_T):
        ...
        delta_arr = (self.emperical_intensity_matrix - matrix_by_alpha) ** 2
        return delta_arr.sum()
    def calc_delta_matrix_SYM(self, A_to_G, A_to_C, A_to_T, G_to_C, G_to_T, C_to_T):
        matrix_by_alpha = self.models_of_evolution_class.SYM(A_to_G, A_to_C, A_to_T, G_to_C, G_to_T, C_to_T)
        delta_arr = (self.emperical_intensity_matrix - matrix_by_alpha) ** 2
        return delta_arr.sum()
    ...
    def calc_derivative_for_one_param_SYM(self, A_to_G, A_to_C, A_to_T, G_to_C, G_to_T, C_to_T, check_param, dx=0.0001):
        if check_param == 'A_to_G':
            return (self.calc_delta_matrix_SYM(A_to_G + dx, A_to_C, A_to_T, G_to_C, G_to_T, C_to_T) - self.calc_delta_matrix_SYM(A_to_G, A_to_C, A_to_T, G_to_C, G_to_T, C_to_T)) / dx
        elif check_param == 'A_to_C':
            return (self.calc_delta_matrix_SYM(A_to_G, A_to_C + dx, A_to_T, G_to_C, G_to_T, C_to_T) - self.calc_delta_matrix_SYM(A_to_G, A_to_C, A_to_T, G_to_C, G_to_T, C_to_T)) / dx
        elif check_param == 'A_to_T':
            return (self.calc_delta_matrix_SYM(A_to_G, A_to_C, A_to_T + dx, G_to_C, G_to_T, C_to_T) - self.calc_delta_matrix_SYM(A_to_G, A_to_C, A_to_T, G_to_C, G_to_T, C_to_T)) / dx
        elif check_param == 'G_to_C':
            return (self.calc_delta_matrix_SYM(A_to_G, A_to_C, A_to_T, G_to_C + dx, G_to_T, C_to_T) - self.calc_delta_matrix_SYM(A_to_G, A_to_C, A_to_T, G_to_C, G_to_T, C_to_T)) / dx
        elif check_param == 'G_to_T':
            return (self.calc_delta_matrix_SYM(A_to_G, A_to_C, A_to_T, G_to_C, G_to_T + dx, C_to_T) - self.calc_delta_matrix_SYM(A_to_G, A_to_C, A_to_T, G_to_C, G_to_T, C_to_T)) / dx
        elif check_param == 'C_to_T':
            return (self.calc_delta_matrix_SYM(A_to_G, A_to_C, A_to_T, G_to_C, G_to_T, C_to_T + dx) - self.calc_delta_matrix_SYM(A_to_G, A_to_C, A_to_T, G_to_C, G_to_T, C_to_T)) / dx
    ...
    def calc_best_params_for_SYM(self, step=0.01, count_of_epochs=1000):
        A_to_G = 100
        A_to_C = 100
        A_to_T = 100
        G_to_C = 100
        ...
        C_to_T = 100
        for _ in range(count_of_epochs):
            A_to_G -= step * self.calc_derivative_for_one_param_SYM(A_to_G, A_to_C, A_to_T, G_to_C, G_to_T, C_to_T, check_param = 'A_to_G')
            A_to_C -= step * self.calc_derivative_for_one_param_SYM(A_to_G, A_to_C, A_to_T, G_to_C, G_to_T, C_to_T, check_param = 'A_to_C')
            A_to_T -= step * self.calc_derivative_for_one_param_SYM(A_to_G, A_to_C, A_to_T, G_to_C, G_to_T, C_to_T, check_param = 'A_to_T')
            G_to_C -= step * self.calc_derivative_for_one_param_SYM(A_to_G, A_to_C, A_to_T, G_to_C, G_to_T, C_to_T, check_param = 'G_to_C')
            G_to_T -= step * self.calc_derivative_for_one_param_SYM(A_to_G, A_to_C, A_to_T, G_to_C, G_to_T, C_to_T, check_param = 'G_to_T')
            C_to_T -= step * self.calc_derivative_for_one_param_SYM(A_to_G, A_to_C, A_to_T, G_to_C, G_to_T, C_to_T, check_param = 'C_to_T')
        result_delta = self.calc_delta_matrix_SYM(A_to_G, A_to_C, A_to_T, G_to_C, G_to_T, C_to_T)
        return [[A_to_G, A_to_C, A_to_T, G_to_C, G_to_T, C_to_T], result_delta]
    ...
    def calc_llf_F81(self, params_f81):
        ...
        while i < len(p_matrix):
            ...
            i += 1
        return counter
    def calc_llf_SYM(self, params_sym):

        q_matrix = self.models_of_evolution_class.SYM(*params_sym[0])
        p_matrix = scipy.linalg.expm(q_matrix * self.time)
        counter = 0
        i = 0
        while i < len(p_matrix):
    ...
    def predict(self, print_datas=True):
        ...
        params_sym = self.calc_best_params_for_SYM()
        ...
        llf_sym = self.calc_llf_SYM(params_sym)
        ...
        if print_datas:
            ...
            print(f'Best params for SYM: {params_sym[0]}')
            ...
            print(f'LLF(loglikelihood) for SYM: {llf_sym}')
            ...
            print(f'Difference points for SYM method taking into account the complexity of the model: {params_sym[1]}')
        min_model = min(params_jc69[1], params_k81[1], params_f81[1], params_sym[1])
        ...
        if params_f81[1]  == min_model:
            ...
            return 2
        if params_sym[1]  == min_model:
            if print_datas:
                print('Predicted model: SYM')
                print(f'Best params: {params_sym[0]}')
            return 3
