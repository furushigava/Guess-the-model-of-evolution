...
class Model_Evolution_Predictor():
    ...
    def calc_delta_matrix_F81(self, frequency_A, frequency_G, frequency_C, frequency_T):
        ...
        delta_arr = (self.emperical_intensity_matrix - matrix_by_alpha) ** 2
        return delta_arr.sum()
    def calc_delta_matrix_GTR(self, A_to_G, A_to_C, A_to_T, G_to_C, G_to_T, C_to_T):
        matrix_by_alpha = self.models_of_evolution_class.GTR(A_to_G, A_to_C, A_to_T, G_to_C, G_to_T, C_to_T)
        delta_arr = (self.emperical_intensity_matrix - matrix_by_alpha) ** 2
        return delta_arr.sum()
    ...
    def calc_derivative_for_one_param_GTR(self, A_to_G, A_to_C, A_to_T, G_to_C, G_to_T, C_to_T, check_param, dx=0.0001):
        if check_param == 'A_to_G':
            return (self.calc_delta_matrix_GTR(A_to_G + dx, A_to_C, A_to_T, G_to_C, G_to_T, C_to_T) - self.calc_delta_matrix_GTR(A_to_G, A_to_C, A_to_T, G_to_C, G_to_T, C_to_T)) / dx
        elif check_param == 'A_to_C':
            return (self.calc_delta_matrix_GTR(A_to_G, A_to_C + dx, A_to_T, G_to_C, G_to_T, C_to_T) - self.calc_delta_matrix_GTR(A_to_G, A_to_C, A_to_T, G_to_C, G_to_T, C_to_T)) / dx
        elif check_param == 'A_to_T':
            return (self.calc_delta_matrix_GTR(A_to_G, A_to_C, A_to_T + dx, G_to_C, G_to_T, C_to_T) - self.calc_delta_matrix_GTR(A_to_G, A_to_C, A_to_T, G_to_C, G_to_T, C_to_T)) / dx
        elif check_param == 'G_to_C':
            return (self.calc_delta_matrix_GTR(A_to_G, A_to_C, A_to_T, G_to_C + dx, G_to_T, C_to_T) - self.calc_delta_matrix_GTR(A_to_G, A_to_C, A_to_T, G_to_C, G_to_T, C_to_T)) / dx
        elif check_param == 'G_to_T':
            return (self.calc_delta_matrix_GTR(A_to_G, A_to_C, A_to_T, G_to_C, G_to_T + dx, C_to_T) - self.calc_delta_matrix_GTR(A_to_G, A_to_C, A_to_T, G_to_C, G_to_T, C_to_T)) / dx
        elif check_param == 'C_to_T':
            return (self.calc_delta_matrix_GTR(A_to_G, A_to_C, A_to_T, G_to_C, G_to_T, C_to_T + dx) - self.calc_delta_matrix_GTR(A_to_G, A_to_C, A_to_T, G_to_C, G_to_T, C_to_T)) / dx
    ...
    def calc_best_params_for_GTR(self, step=0.01, count_of_epochs=1000):
        ...
        C_to_T = 100
        for _ in range(count_of_epochs):
            A_to_G -= step * self.calc_derivative_for_one_param_GTR(A_to_G, A_to_C, A_to_T, G_to_C, G_to_T, C_to_T, check_param = 'A_to_G')
            A_to_C -= step * self.calc_derivative_for_one_param_GTR(A_to_G, A_to_C, A_to_T, G_to_C, G_to_T, C_to_T, check_param = 'A_to_C')
            A_to_T -= step * self.calc_derivative_for_one_param_GTR(A_to_G, A_to_C, A_to_T, G_to_C, G_to_T, C_to_T, check_param = 'A_to_T')
            G_to_C -= step * self.calc_derivative_for_one_param_GTR(A_to_G, A_to_C, A_to_T, G_to_C, G_to_T, C_to_T, check_param = 'G_to_C')
            G_to_T -= step * self.calc_derivative_for_one_param_GTR(A_to_G, A_to_C, A_to_T, G_to_C, G_to_T, C_to_T, check_param = 'G_to_T')
            C_to_T -= step * self.calc_derivative_for_one_param_GTR(A_to_G, A_to_C, A_to_T, G_to_C, G_to_T, C_to_T, check_param = 'C_to_T')
        result_delta = self.calc_delta_matrix_GTR(A_to_G, A_to_C, A_to_T, G_to_C, G_to_T, C_to_T)
