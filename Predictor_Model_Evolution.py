...
class Model_Evolution_Predictor():
    ...
    def calc_derivative_for_one_param_GTR(self, A_to_G, A_to_C, A_to_T, G_to_C, G_to_T, C_to_T, check_param, dx=0.0001):
    ...
    def calc_llf_GTR(self, params_gtr):
        ...
        q_matrix = self.models_of_evolution_class.SYM(*params_gtr[0])
        p_matrix = scipy.linalg.expm(q_matrix * self.time)
        counter = 0
        i = 0
        while i < len(p_matrix):
    ...
    def predict(self, print_datas=True):
        ...
        params_gtr = self.calc_best_params_for_SYM()
        ...
        if print_datas:
            ...
            print(f'Best params for SYM: {params_gtr[0]}')
            ...
            print(f'LLF(loglikelihood) for SYM: {llf_gtr}')
            ...
            print(f'Difference points for SYM method taking into account the complexity of the model: {params_gtr[1]}')
